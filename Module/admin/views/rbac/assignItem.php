...
<div class="page-container">
	...
	<div class="mt-20">
        ...
        <?php echo Html::label('角色标识:',null,['class'=>'span2']).Html::encode($rolename) ?>
        <br>
        <?php echo Html::label('子角色:',null,['class'=>'span2']).Html::checkBoxList('children',$children['roles'],$roles) ?>

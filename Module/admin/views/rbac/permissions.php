...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"> <a class="btn btn-primary radius" onclick="o2o_s_edit('添加权限','<?php echo yii\helpers\Url::to(['rbac/addpermission']) ?>','','300')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加权限</a></span> <span class="r"></span> </div>
	<div class="mt-20">
                                ...
                                [
                                    ...
                                    'buttons' => [
                                        'update'=>function($url,$model,$key){
                                            return Html::a('更新',['addpermission','name'=>$model['name']]);
                                        },
